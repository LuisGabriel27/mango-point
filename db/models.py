...
class Orchard(Base):
    ...
    orthophoto_png_path: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    orthophoto_bounds: Mapped[Optional[List[float]]] = mapped_column(JSON, nullable=True)
    orthophoto_coordinates: Mapped[Optional[List[List[float]]]] = mapped_column(JSON, nullable=True)
    dtm_path: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    dsm_path: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
