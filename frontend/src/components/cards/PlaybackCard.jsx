...
export default function PlaybackCard({ frames = [], currentFrameIdx = 0, onFrameSeek, defaultOpen = true }) {
  ...
  return (
    <CollapsibleCard iconName="film" title="Playback" defaultOpen={defaultOpen}>
      {disabled ? (
