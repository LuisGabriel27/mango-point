...
def _fit_nonnegative_affine(
    ...
    if variance <= 1e-12:
        return 1.0, 0.0, "constant_raw_scores_identity"
...
class PestCalibrationCurve:
    ...
    def level(self, calibrated_score: float) -> str:
...
class ValidationCalibration:
    ...
    def predict_level(self, calibrated_score: float, pest_type: str) -> str:
        return self.curve_for(pest_type).level(calibrated_score)
